...
ln -s "$DEST/libero" "$CUR/playground/Datasets"
ln -s "$DEST/LLaVA-OneVision-COCO" "$CUR/playground/Datasets/LLaVA-OneVision-COCO"

## move modality
cp "$CUR/examples/LIBERO/train_files/modality.json" "$CUR/playground/Datasets/libero_10_no_noops_1.0.0_lerobot/meta"
cp "$CUR/examples/LIBERO/train_files/modality.json" "$CUR/playground/Datasets/libero_goal_no_noops_1.0.0_lerobot/meta"
cp "$CUR/examples/LIBERO/train_files/modality.json" "$CUR/playground/Datasets/libero_object_no_noops_1.0.0_lerobot/meta"
cp "$CUR/examples/LIBERO/train_files/modality.json" "$CUR/playground/Datasets/libero_spatial_no_noops_1.0.0_lerobot/meta"
